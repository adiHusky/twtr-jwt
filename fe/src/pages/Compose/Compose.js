...
//       TWO: '1+1',
//       'process.env': {
//         REACT_APP_BE_NETWORK: JSON.stringify(process.env.REACT_APP_BE_NETWORK),
//         REACT_APP_BE_PORT: JSON.stringify(process.env.REACT_APP_BE_PORT)
//       },
...
const Compose = () => {
  ...
  const postTweet = async (user, description, priv, pic) => {
    ...
    try {
      ...
      const response = await fetch("http://flask-react-alb-1300309328.us-east-1.elb.amazonaws.com/tweet", config)
